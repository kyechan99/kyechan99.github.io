...
### argTypes - if
뜻 그대로 조건문입니다.
어떤 props를 사용한다 할때 조건을 사용할 수 있습니다.
...
```
보통 Typescript를 사용하면 알아서 options도 정해주는데, mapping은 해당 값을 말그대로 다시 매핑할때 사용한다 생각하면 된다고 생각합니다.
...
![2](/img/2023-11-15-Storybook/2.png)
...
![3](/img/2023-11-15-Storybook/3.png)
...
![4](/img/2023-11-15-Storybook/4.png)
