...
- Assets/Vuforia/Prefabs 에 **ARCamera**와 **ImageTarget**을 _Hierachy_ 로 꺼낸다.
...
2. **ImageTarget** 오브젝트의 _Database_ 부분에 방금 만든 Database의 Name으로 변경해준다.
...
- ※ 만일 아래와 같이 여전히 흰색판이 보일경우에만 봅니다.
  ...
  1. _Assets/Editor/QCAR/ImageTargetTexture/이름_ 으로 들어간다.
